...
Deno.test("builder", async (t) => {
  await t.step("should format a URL", () => {
    ...
    assertEquals(
      result?.toString(),
      "https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F462d29d57dda42cb9e26441501db535f?width=200&height=100",
    );
  });
  ...
  await t.step("should round non-integer params", () => {
    ...
    assertEquals(
      result?.toString(),
      "https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F462d29d57dda42cb9e26441501db535f?width=201&height=100",
    );
  });
});
